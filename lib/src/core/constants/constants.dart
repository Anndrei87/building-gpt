...
const scaffoldbackground = Color(0xFF343541);
const cardColor = Color(0xFF444654);
...
List<DropdownMenuItem<String>>? get getModelsItem {
  final modelsItems = List<DropdownMenuItem<String>>.generate(
    models.length,
...
const chatMessages = [
  ...
  {
    'msg':
        'You re welcome! Let me know if you have any other questions or if theres anything else I can help you with.',
    'chatIndex': 1,
  },
];
